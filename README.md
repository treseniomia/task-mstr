...
**TaskMaster Pro** is a productivity application. It combines a sleek Pomodoro Timer with robust task management, emphasizing a clean, decoupled architecture and a premium user experience.

----

## Features

* Intelligent **Pomodoro Timer**: A focus-driven timer with a dynamic circular progress ring.
* **Persistent State**: Leveraging `AsyncStorage` to ensure timer continuity even after app termination or device reboots.
